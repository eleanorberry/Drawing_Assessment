...
button_list.push(new Button(x,y+450,w,h, Line_list[0], colArray[1][0], colArray[1][9], colArray[1][10]))
for (let i=0; i<(Line_list.length-1) ; i++){
    button_list.push(new Size_button(x+i*66.66,(y+450)+h,66.6,h, Line_list[i+1],colArray[1][0], colArray[1][9], colArray[1][10]))
}
// defining the flower and Petal button
let flower_list = ["Flower", "4", "5", "6","7"]
button_list.push(new Button(x,y+343,w,h, flower_list[0], colArray[1][0], colArray[1][9], colArray[1][10]))
for (let i=0; i<(flower_list.length-1) ; i++){
    button_list.push(new Flower_button(x+i*50,(y+343)+h,50,h, flower_list[i+1],colArray[1][0], colArray[1][9], colArray[1][10]))
}
...
//let H = new Heart(0,0, 50, 50, "rgb(255,0,0)")
function animate(){
