...
button_list.push(new Button(x,y+531.5,w,h, Line_list[0], colArray[1][0], colArray[1][9], colArray[1][10]))
for (let i=0; i<(Line_list.length-1) ; i++){
    button_list.push(new Size_button(x+i*66.66,(y+531.5)+h,66.6,h, Line_list[i+1],colArray[1][0], colArray[1][9], colArray[1][10]))
}
